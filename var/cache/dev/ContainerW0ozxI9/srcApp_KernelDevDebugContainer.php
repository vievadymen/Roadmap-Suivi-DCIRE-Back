...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    /**
     * Gets the private '.service_locator.2m8UJaw' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_2m8UJawService()
    {
        return $this->privates['.service_locator.2m8UJaw'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
    ...
    protected function getAcmeApi_Event_JwtCreatedListenerService()
    {
        ...
        return $this->privates['acme_api.event.jwt_created_listener'] = new \App\Event\JwtCreatedSubscriber(($this->privates['App\\Repository\\UserRepository'] ?? $this->getUserRepositoryService()));
    }
