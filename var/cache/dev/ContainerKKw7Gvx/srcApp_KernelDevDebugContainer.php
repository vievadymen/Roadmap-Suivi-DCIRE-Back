...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    protected function getWorkflowControllerService()
    {
        ...
        return $this->services['App\\Controller\\WorkflowController'] = new \App\Controller\WorkflowController(($this->privates['App\\Service\\BaseService'] ?? $this->getBaseServiceService()));
    }
