 ...
 */
final class Version20211110131039 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE activite ADD heure TIME DEFAULT NULL, DROP start_time, DROP end_time');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE activite ADD end_time TIME DEFAULT NULL, CHANGE heure start_time TIME DEFAULT NULL');
